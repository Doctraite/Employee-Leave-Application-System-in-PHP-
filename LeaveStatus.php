...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">Health Regional Leavem Managemnt System</a>
    </div>
...
if(!$exist)
{
            ...
            echo '</script>';
             echo "<h1 style='color:white;text-align:center;background-color:gray'>You  Have Not Requested for a <b> <span style='color:Green'> Leave Yet</span> </b>";
}
else
{
